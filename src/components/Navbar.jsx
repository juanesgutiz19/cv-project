          ...
          {(ref) => (
            <div className='md:hidden' id='mobile-menu'>
              <div ref={ref} className='px-2 pt-2 pb-3 space-y-1 sm:px-3'>
                ...
                <OptionComponent isSmallSize optionName='Projects' />
                <OptionComponent isSmallSize optionName='Certifications' />
                <OptionComponent isSmallSize optionName='Contact' />
              </div>
            </div>
          )}
        </Transition>
