    ...
    return (
        <div className="overflow-hidden shadow-2xl rounded-sm bg-white">
            ...
            <div className="px-6 pt-4 pb-4 text-center">
                <a href={ projectLink } target="_blank" rel="noopener noreferrer" className=" hover:underline hover:decoration-white"><span className="bg-gray-700 rounded-full px-5 py-1 text-base font-normal text-white mr-2 mb-2">View project</span></a>
            </div>
        </div>
    )
}
