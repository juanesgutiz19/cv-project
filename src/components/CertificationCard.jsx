...
const CertificationCard = ( { certificationName, platform, picture, certificationLink } ) => {
    return (
        <div className="">
            <div className="flex flex-col md:flex-row rounded-sm bg-white shadow-xl">
                <img className=" w-full md:h-auto object-cover md:w-48 rounded-sm" src={ picture } alt="Certification platform" />
                <div className="p-6 flex flex-col justify-between">
                        <div>
                            <h5 className="text-gray-900 text-2xl md:text-3xl font-bold mb-2">{ certificationName }</h5>
